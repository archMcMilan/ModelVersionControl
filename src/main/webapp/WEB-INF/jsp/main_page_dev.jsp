            ...
            <div class="table-container" id="table">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="edit" method="post">
                                <button class="btn btn-warning" type="submit" title="Edit" onclick="handleClick();">
...
<c:if test="${isEdit eq true}">
    <div class="panel panel-default" id="edit_form" >
        <div class="panel-body">
            <form action="addNewVersion" enctype="multipart/form-data" method="post">
                <div class="form-group">
